...
public class CategoryDaoJdbc implements CategoryDao {
    ...
    public Category findByName(String name) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding category with name " + name, e);
        }
        return category;
    }
    ...
    public Category findByCategoryName(String categoryName) {
        // Assuming this is a duplicate method of findByName() or meant to handle
        // specific cases with alternate naming conventions.
